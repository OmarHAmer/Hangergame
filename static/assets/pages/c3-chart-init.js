...
!function($) {
    ...
    ChartC3.prototype.init = function () {
        ...
        c3.generate({
            ...
            data: {
                columns: [
                    ['Revenue', 13000, 12000, 15000, 14000, 16000, 15000, 13000, 12000, 15000, 14000, 16000, 15000],
                    ['Pageview', 20000, 13000, 9000, 24000, 13000, 22000, 20000, 13000, 9000, 24000, 13000, 22000]
                ],
                types: {
                    Revenue: 'area-spline',
